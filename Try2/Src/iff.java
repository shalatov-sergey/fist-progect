...
//Здравствуйте, я знаю что тут много недочетов, слишком много строк (можно было сделать намного лучше и короче), но я именно для этого к вам и иду. Вот например этот код (который я написал за день - чтбоы успеть до 18 числа) - даже с такой ужасной структурой почти послностью работает БЕЗ пробелов. Так как в задании не было ничего о них сказано, а в примерах есть или нет, я так и не понял. Я сделал без них. И я понимаю, что код должен быть универсален, но если я сделал это за день (не имея представления до этого о java). Пожалуйста посмотрите решение кода без пробелов между вводимыми символами. 
